let about_template = 
`
    <div href="" class="h-96 bg-white hover:scale-90 transition-transform duration-500 ease-out text-center space-y-5 col-span-1 mx-auto w-ninetyPercent sm:w-auto">
